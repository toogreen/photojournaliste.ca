...
<!-- TITLE BEGIN -->
<div align="center"><font size='4' face='Verdana, Arial, Helvetica, sans-serif'><b><?echo($sub);?> lesson plans for <?echo($name);?></b></font><br><br></div>
<!-- TITLE END -->
...
<input type="hidden" name="uid" value="<? echo($uid);?>">
    ...
    <tr valign="top" bgcolor="#FFFFFF"> 
    <td width="10%"><textarea cols="10" rows="3" name="ud_own"><? echo($own);?></textarea></td>
    <td width="80%"><textarea cols="70" rows="3" name="ud_proc"><? echo($proc);?></textarea></td>
    <td width="10%"><textarea cols="10" rows="3" name="ud_inter"><? echo($inter);?></textarea></td>
    </tr>
